/*global history */
sap.ui.define([
		"com/company/wishlist/ui/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"com/company/wishlist/ui/model/formatter",
		"com/company/wishlist/ui/model/grouper",
		...
		return BaseController.extend("com.company.wishlist.ui.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.company.wishlist.ui.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("productPrice", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("productPrice", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
